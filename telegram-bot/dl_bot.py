...
class DLBot(object):
    ...
    def __init__(self, token, user_id=None):
        ...
        self.startup_message = "Hi, I'm Kurt! I will send you updates on your training process. \n" \
                                "Beware, sometimes you may see your results and say after 3 hours and 45 minutes, What the Hell!"\
